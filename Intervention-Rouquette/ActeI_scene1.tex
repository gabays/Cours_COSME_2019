...
% Glossaires (à compléter)
\renewcommand{\pagelinesep}{.}
\glstoctrue
\makeglossaries
\longnewglossaryentry{Hector}{name=Hector}{
  Héros troyen de la guerre de Troie. Fils du roi Priam et de la reine Hécube, il est tué par Achille qui veut venger la mort de Patrocle.

   Référence: \url{https://fr.wikipedia.org/wiki/Hector}
}

\longnewglossaryentry{Menelas}{name=Ménélas}{
   \sloppy Personnage de la mythologie grecque, roi de Sparte, fils d'Atrée et d'Érope. Mari d'Hélène et frère d'Agamemnon, il est l'un des héros achéens de la guerre de Troie.

   Référence: \url{https://fr.wikipedia.org/wiki/Ménélas}
}
\begin{document}
...
\app%
  {Qui m'euſt dit,}%
  {1668a}%
  {Qui l'euſt dit, \wit{1697}}
  qu'vn riuage à mes vœux ſi funeſte,&
...
Aſtyanax, d'\edgls{Hector} jeune \ampersand\  malheureux Fils,&
