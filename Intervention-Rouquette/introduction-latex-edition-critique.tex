...
\begin{frame}
	\titlepage
  \linkintitlepage{https://geekographie.maieul.net/225}
\end{frame}
...
\begin{slide}
  \begin{itemize}
    \item Il existe des outils pour basculer de TEI vers \package{reledmac} : cf. Annexe B du manuel de \package{reledmac}
